...
<body>
    ...
    $userrow = $database->query("select * from patient where pcontact='$usercontact'");
                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    ...
                                    <p class="profile-subtitle"><?php echo substr($usercontact,0,22)  ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
...
?>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <!-- <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">All Doctors (<?php echo ($list11)? mysqli_num_rows($list11) :0; ?>)</p> -->
                    </td>
